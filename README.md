...
1. Проверка таймаутов позиций — если позиция открыта дольше **MAX_POSITION_BARS = 144 баров (~36 часов для 15m)**, она принудительно закрывается с причиной TIMEOUT
