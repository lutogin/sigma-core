...
class EventEmitter:
    ...
    async def emit(self, event: BaseEvent) -> None:
        ...
        Supports both sync and async handlers via pyee.AsyncIOEventEmitter.
        ...
        # Emit to subscribers (pyee.AsyncIOEventEmitter handles async handlers)
    ...
    def get_stats(self) -> Dict:
        ...
        return {
            ...
            "listeners": {et.value: self.get_listener_count(et) for et in EventType},
        }
